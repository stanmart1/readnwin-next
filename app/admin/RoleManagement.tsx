...
export default function RoleManagement() {
    ...
    try {
      ...
      for (const permissionId of currentPermissionIds) {
        if (!selectedPermissions.includes(permissionId)) {
          await fetch(`/api/admin/roles/${selectedRole.id}/permissions?permission_id=${permissionId}`, {
            method: 'DELETE'
          });
        }
      }
  ...
  const getRoleColor = (roleName: string) => {
    switch (roleName) {
      ...
      case 'editor': return 'bg-gradient-to-r from-yellow-500 to-orange-500';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {roles.map((role) => (
          <div key={role.id} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">{role.display_name}</h3>
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setCreatingRole({...creatingRole, name: e.target.value})}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setCreatingRole({...creatingRole, display_name: e.target.value})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) => setCreatingRole({...creatingRole, description: e.target.value})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    rows={3}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setCreatingRole({...creatingRole, priority: parseInt(e.target.value)})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    min="0"
                    max="100"
                  />
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    {isEditingPermissions ? 'Select permissions to assign to this role' : 'View current permissions'}
                  </p>
                </div>
              ...
              {isEditingPermissions ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {permissions.map((permission) => (
                    <div key={permission.id} className={`rounded-lg p-4 border-2 transition-all duration-200 ${
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center text-xs text-gray-500">
                            <span className="mr-2">Action: {permission.action}</span>
