...
/**
 * Comprehensive Fix Script for About Us and Permissions System (Corrected)
 *
 * This script:
 * 1. Creates the missing about_us table
 * 2. Creates missing permissions with correct schema
 * 3. Updates role permissions with correct schema
 * 4. Creates API endpoints for About Us management
 * 5. Verifies admin tab permission mappings
 */
...
// Additional permissions using correct dot notation based on existing system
...
async function createMissingPermissions() {
  ...
  try {
    ...
    for (const permission of missingPermissions) {
      await query(`
        INSERT INTO permissions (name, resource, action, display_name, created_at)
        VALUES ($1, $2, $3, $4, NOW())
...
async function main() {
  log('🚀 Starting About Us and Permissions System Fix (Corrected)', 'bold');
