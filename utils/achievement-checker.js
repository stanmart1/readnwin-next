...
class AchievementChecker {
  ...
  static async checkBooksCompleted(userId, requiredCount) {
  ...
  static async checkReadingStreak(userId, requiredDays) {
    const result = await query(`
  ...
  static async checkTotalPages(userId, requiredPages) {
    const result = await query(`
  ...
  static async checkTotalHours(userId, requiredHours) {
    const result = await query(`
  ...
  static async checkReviewsWritten(userId, requiredCount) {
    const result = await query(`
      SELECT COUNT(*) as count
      FROM book_reviews
  ...
  static async checkGenresRead(userId, requiredGenres) {
    const result = await query(`
  ...
  static async checkMonthlyBooks(userId, requiredBooks) {
    const result = await query(`
